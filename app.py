...
def main():
    ...
    #The label option that is selected from selectbox will be assigned to classifier varibale
    ...
    if classifier=="Support Vector Machine(SVM)":
        ...
        #key is used to uniquely identify the widget and here the widget is number_input(label,min_value,max_value,step=None,key="")
        C=st.sidebar.number_input(label="C (Regularisation parameter)",min_value=0.01,max_value=10.0,step=0.01,key='C')
        #key is used to uniquely identify the widget and here the widget is radio(label,options=(""),key="")
        ...
        #every time the new user uses different metrics or hyperparametres we don't need to reload the entire web app,so we use button widget
